...
def add_viewpoint_structures(c):
...
if __name__ == '__main__':
    ...
    constants = RELEVEN.PBWstarConstants.PBWstarConstants(store=store)
    # Do the deed
    add_viewpoint_structures(constants)
    # Document this script
    responsible = constants.graph.value(None, constants.entity_label, Literal('Andrews, Tara Lee'))
    constants.record_script_run(responsible)